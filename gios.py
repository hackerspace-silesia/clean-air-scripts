...
def gios():
    ...
    total_values = len(merged_ids_lat_long)
    for i, values in enumerate(merged_ids_lat_long):
    ...
    import pprint as p; p.pprint(final_list_of_measurements_in_dictionary)
